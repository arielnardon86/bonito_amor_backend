# Script para crear una tienda en staging local
# Uso: .\scripts\crear_tienda_staging.ps1 [nombre_tienda] [direccion] [telefono] [email]

param(
    [Parameter(Position=0)]
    [string]$NombreTienda = "Tienda Staging",
    ...
    [string]$Email = "tienda@staging.com"
)
...
Write-Host "=== Creando tienda en STAGING ===" -ForegroundColor Cyan
