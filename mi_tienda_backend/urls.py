...
def api_root(request, format=None):
    return Response({
        ...
        'metricas-ventas': reverse('metricas-ventas-list', request=request, format=format),
        'metodos-pago': reverse('payment_methods', request=request, format=format),
...
urlpatterns = [
    ...
    path('api/payment-methods/', PaymentMethodListView.as_view(), name='payment_methods'),
